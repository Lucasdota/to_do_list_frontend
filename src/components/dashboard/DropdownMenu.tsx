...
export default function DropdownMenu({ setMenu }: Props) {
    ...
    <ul
      ref={configSection}
      className="absolute w-full h-full z-10 bg-slate-200/30 backdrop-blur-lg flex flex-col items-center justify-center gap-2"
    >
      <button
      ...
      {isSurePopUp ? (
        <li className="w-72 flex flex-col items-center justify-center gap-2">
